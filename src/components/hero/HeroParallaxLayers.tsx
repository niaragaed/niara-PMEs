...
export function HeroParallaxLayers() {
  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
      ...
      <div
        ref={orbitRef}
        className="absolute left-1/2 top-1/2 h-[420px] w-[420px] -translate-x-1/2 -translate-y-1/2 opacity-[0.14] sm:h-[560px] sm:w-[560px]"
      >
        <svg viewBox="0 0 200 200" className="h-full w-full" fill="none">
          <circle cx="100" cy="100" r="72" stroke="var(--color-military)" strokeWidth="1.5" />
          <ellipse
            cx="100"
            cy="100"
            rx="98"
